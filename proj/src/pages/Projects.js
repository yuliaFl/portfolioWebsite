          ...
          <Card>
            ...
            <Card.Body>
              ...
              <Card.Text className="cardText">
                ...
                Engaging carousel to showcase reviews. Buttons
                that adjust their position dynamically as the screen size
                changes and change color on hover for better interactivity.
                Dropdown buttons for easy access to additional options. The
                entire site adapts to different phone and screen sizes, ensuring
          ...
          <Card>
            ...
            <Card.Body>
              ...
              <Card.Text className="cardText">
                ...
                with an option of register, login in, or guest. Once logged in,
                has option to search a movie or view saved movies. Searching a
                movie is done by fetching an IMDB API. Saved movies are stored
                with redux
              </Card.Text>
            </Card.Body>
          </Card>
          ...
          <Card>
            ...
            <Card.Body>
              ...
              <Card.Text className="cardText">
                ...
                Given an input, the user can search up a word which returns a
                wide range of data to provide a comprehensive result about the
          ...
          <Card>
            ...
            <Card.Body>
              ...
              <Card.Text className="cardText">
                ...
                the option to register and log in. Once logged in, they can
                edit, delete, and add books. If not registered or logged in,
                they can only view the book list
              </Card.Text>
            </Card.Body>
          </Card>
        </div>
          ...
          <Card>
            ...
            <Card.Body>
              ...
              <Card.Text className="cardText">
                ...
                whole meals. You can also add your favorite foods and sort them
                into categories. Project is being done on both React and
                ReactNative
              </Card.Text>
            </Card.Body>
          </Card>
